// src/features/dashboard/commercial/activites/activites.ts
...
@Component({
  selector: 'app-commercial-activites',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './activites.html',
  styleUrl: './activites.css',
})
export class CommercialActivites implements OnInit {
  ...
  getActivityColor(type: string): string {
    const colors: Record<string, string> = {
      ...
      aide:        'bg-pink-100 text-pink-600',
    };
